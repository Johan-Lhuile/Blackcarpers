...
<footer class=" inset-x-0 bottom-0 m-auto px-4 py-8 mt-20 bg-black sm:fixed">
	<div class="container max-w-7xl px-8 flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
		<div class="flex flex-row pr-3 space-x-4 sm:space-x-8">
			...
			<ul class="text-gray-100 flex flex-wrap items-center space-x-4 sm:space-x-8">
				<li>
					<a rel="noopener noreferrer" href="#"></a>
				</li>
				<li>
                <p>Copyright © 2023 BLACKCARPERS</p>
				</li>
			</ul>
		</div>
